...
```{r echo=F, tidy = T, comment = "#", collapse=T, warning=F}
...
However, the analysis of the residuals showed some traces of a remaining seasonality, of different latency. 
...
Note that the weighting was done without keeping the outlier subareas into account, to avoid skewing the results.

| **MODEL** | **MSE** | **MAPE** | **MAXAPE** | **OTHER** |
|:------:|:------:|:------:|:------:|:------:|
| **Sarima** | 2.146717  | 0.3211637 | 1.028536 | - | 
| **Random Forest** | 2.179245 | 0.2865883 |4.188574 | *Out of bag:* 1.771598 | 
| **XGBoost** | asd | asda | asd | asdas | 
