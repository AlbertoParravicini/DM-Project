...
The values replaced are the ones at *"2014-01-01"*, *"2014-6-30"*, and from *"2014-03-19"* to *"2014-03-25"* (in the 2 following years, sales at *"01-01"* are usually rather low, but never completely 0 as in 2014)
...
XGBoost watchlist allows to estimate the prediction error over a given testset during the training phase. This gives a more robust measurement of the model quality and is helpful to avoid overfitting the traning set. Early stopping can be used to halt the training if the error over the testset doesn't decrease over a certain amount of iterations, furtherly reducing the risk of overfitting.
