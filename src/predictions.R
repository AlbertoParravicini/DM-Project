...
# carica il train, test, predset (le 4 righe qui sopra)

# res <- rfs(train, test, num_trees = 1200, details = T)
...
# idem per res@prediction_table, ci serve per stimare gli sse sulle sottoaree
